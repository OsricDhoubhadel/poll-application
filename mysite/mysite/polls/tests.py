...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """Detail view of a question with a publish date in the future returns a 404 not found"""
    ...
    def test_past_question(self):
        """The detail view of a questoin with a publish date in the past displays the past's text"""
